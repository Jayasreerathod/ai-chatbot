...
// API setup
const API_KEY ="AIzaSyDhlXA3k5ngDNaOXcF9VP9519_-cWVpnwA";
...
const generateResponse = async (botMsgDiv) => {
    ...
    try {
        ...
        //  Save bot’s message to chatHistory
        chatHistory.push({
            role: "model",
...
const handleFormSubmit = (e) => {
    ...
    const botMsgHTML = `<img src="img.jpg"  class="avatar" ><p class="message-text">Wait a moment...</p>`;
